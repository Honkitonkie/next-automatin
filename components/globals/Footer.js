import Logo from "https://www.automatin.nl/static/automatin.png";
          ...
          <div className='w-full sm:w-2/3 lg:w-3/12 px-4'>
            <div className='w-full'>
              <a href='/' className='inline-block max-w-[220px] mb-6 flex items-center'>
                <Image className='bg-white rounded-full' src={Logo.src} alt='Automatin logo' width='40%' height='40%' />
              ...
              <p className='flex items-center text-sm text-dark font-medium'>
                ...
                <a href='tel:+31(0)618724301'>+31(0)618724301</a>
              </p>
            </div>
          </div>
          <div className='w-full sm:w-1/2 lg:w-2/12 px-4'>
            <div className='w-full mb-10'>
              ...
              <ul>
                <li>
                  <Link href='/shorts'>
                    <span className='hover:text-automatin-orange inline-block text-base text-body-color hover:text-primary leading-loose mb-2 cursor-pointer'>Korte filmpjes</span>
                  </Link>
                </li>
                <li>
                  <Link href='/longs'>
                    <span className='hover:text-automatin-orange inline-block text-base text-body-color hover:text-primary leading-loose mb-2 cursor-pointer'>Lange filmpjes</span>
                  </Link>
                </li>
                <li>
                  <Link href='/plaatjes'>
                    <span className='hover:text-automatin-orange inline-block text-base text-body-color hover:text-primary leading-loose mb-2 cursor-pointer'>Stilstaand</span>
                  </Link>
                </li>
                <li>
                  <Link href='/fotos'>
                    <span className='hover:text-automatin-orange inline-block text-base text-body-color hover:text-primary leading-loose mb-2 cursor-pointer'>Beschikbare foto's</span>
                  </Link>
                </li>
              </ul>
            </div>
          ...
          <div className='w-full sm:w-1/2 lg:w-2/12 px-4'>
            <div className='w-full mb-10'>
              ...
              <ul>
                <li>
                  <Link href='/contact'>
                    <span className='hover:text-automatin-orange inline-block text-base text-body-color hover:text-primary leading-loose mb-2 cursor-pointer'>Website</span>
                  </Link>
                </li>
                <li>
                  <Link href='/contact'>
                    <span className='hover:text-automatin-orange inline-block text-base text-body-color hover:text-primary leading-loose mb-2 cursor-pointer'>Automatisering</span>
                  </Link>
                </li>
                <li>
                  <Link href='/contact'>
                    <span className='hover:text-automatin-orange inline-block text-base text-body-color hover:text-primary leading-loose mb-2 cursor-pointer'>Marketing</span>
                  </Link>
                </li>
                <li>
                  <a
                    className='hover:text-automatin-orange inline-block text-base text-body-color hover:text-primary leading-loose mb-2 cursor-pointer'
                    href='https://automatin.automatin.nl/img/Algemene%20voorwaarden.pdf'
                  >
                    Voorwaarden & Privacy
                  </a>
                </li>
          ...
          <div className='w-full sm:w-1/2 lg:w-2/12 px-4'>
            <div className='w-full mb-10'>
              ...
              <ul>
                <li>
                  <Link href='/contact'>
                    <span className='hover:text-automatin-orange inline-block text-base text-body-color hover:text-primary leading-loose mb-2 cursor-pointer'>Contact</span>
                  </Link>
                </li>
                <li>
                  <Link href='/over'>
                    <span className='hover:text-automatin-orange inline-block text-base text-body-color hover:text-primary leading-loose mb-2 cursor-pointer'>Over</span>
                  </Link>
                </li>
                <li>
                  <Link href='/#pricing'>
                    <span className='hover:text-automatin-orange inline-block text-base text-body-color hover:text-primary leading-loose mb-2 cursor-pointer'>Pricing</span>
                  </Link>
                </li>
                <li>
                  <Link href='/galerij'>
                    <span className='hover:text-automatin-orange inline-block text-base text-body-color hover:text-primary leading-loose mb-2 cursor-pointer'>Templates</span>
                  </Link>
                </li>
              </ul>
            </div>
